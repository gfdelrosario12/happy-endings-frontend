    ...
    <div className="body-content">
      <div className="body-container">
        <section id="Instruction" class="Instruction">
          ...
          <p>
            To use our services at Happy Endings, either <a href="#">Log In</a>{" "}
            or <a href="#">Sign Up</a> to proceed to a new interface.
          </p>
        </section>
        <section id="about" class="about">
          ...
          <p>
            ...
            detail. Join us in making your special day truly memorable, starting
        ...
        <section id="vission" class="vission">
          ...
          <p>
            ...
            share their love story through our user-friendly platform, leaving a
            lasting impression on their guests and cherishing the joy of their
            special day.
          </p>
        </section>
        <section id="team" class="team">
          ...
          <div className="row-container">
            <div className="column-container">
              ...
              <div>
              <p className="ceo-title">Gladwin Del Rosario - CEO and Lead Developer</p>
              <figcaption>
                ...
                tirelessly innovates to simplify the wedding planning process
                and deliver exceptional electronic invitations. John's hands-on
                approach, attention to detail, and unwavering commitment to
                excellence ensure that Happy Endings remains a trusted ally for
                couples, offering memorable experiences and easing the stress of
                their special day.
              </figcaption>
              </div>
            </div>
